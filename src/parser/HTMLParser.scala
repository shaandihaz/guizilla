...
import guizilla.src.OpenHTML
import guizilla.src.CloseHTML
import guizilla.src.OpenParagraph
import guizilla.src.CloseParagraph
import guizilla.src.OpenBody
import guizilla.src.CloseBody
import guizilla.src.OpenLink
import guizilla.src.CloseLink
import guizilla.src.Text
import guizilla.src.Input
import guizilla.src.Submit
import guizilla.src.OpenForm
import guizilla.src.CloseForm
import guizilla.src.Eof
/**
  * A class that parsers an HTML file
  *
  * @param reader - an HTMLTokenizer ready to begin tokenizing an HTML file
  */
class HTMLParser(tokenizer: HTMLTokenizer) {
  ...
  /**
    ...
    */
  //private def tokenizer: HTMLTokenizer = new HTMLTokenizer(reader)
